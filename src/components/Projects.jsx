...
const projects = [
  ...
  {
    title: "Todo App",
    description: "A todolist app with multiple functionalitis",
    image: todo,
    gurl: "https://github.com/AbinashSamal828/todolist-app",
  },
  {
    title: "Quote Library",
    description:
      "A web app made with react.js and firebase where users can post quotes and compliment other qoutes.",
    image: qlib,
